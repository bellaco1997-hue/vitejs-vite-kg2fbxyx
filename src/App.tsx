...
disabled={assignedGroup.id !== "descanso" && assignedGroup.exercises.
...
<div className="cal-day-label">{entry.exCount}ej · {entry.totalSets}s
</>
)}
</div>
);
...
<span style={{ width: 7, height: 7, borderRadius: "50%", background: {g.name}
</div>
getGro
))}
</div>
