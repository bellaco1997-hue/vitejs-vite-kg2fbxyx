    ...
    <div style={{ fontFamily: "'DM Mono', 'Courier New', monospace", background: "#0d0d0d", minHeight: "100vh", color: "#e8e0d0" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cardio-section { background: #0f0f0f; border: 1px solid #1c1c1c; border-radius: 3px; margin-top: 16px; overflow: hidden; }
        .cardio-header { display: flex; justify-content: space-between; align-items: center; padding: 11px 13px; cursor: pointer; }
        .cardio-header:hover { background: #141414; }
        .cardio-row { display: flex; gap: 8px; align-items: center; padding: 6px 13px; border-top: 1px solid #1a1a1a; }
        .cardio-input-type { flex: 1; }
